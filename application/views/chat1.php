...
<html>
    ...
    <body>
        <div class="header-top-w3layouts">
            ...
            <button type="button" id ="accept_call" name="Accept_CAll" onclick="acceptCallInvite()" class="btn btn-primary" >Join Session</button>
	</div>
                ...
                <div class="row justify-content-center h-100" style="margin-top: 30px;margin-bottom: 30px;">
                    <div class="col-md-5 col-xl-6">
                        ...
                        <img id='imgVideo' src="<?php echo base_url("assets/images/videoconnect.jpg"); ?>" class="img" style="height: 100%;cursor:pointer;" onclick='startVideo()'>
                    </div>
...
//                    responseString += '<span class="msg_time_send">9:10 AM, Today</span>';
            ...
            socket.on(user_id + '_start_notf', function (msg, sender) {
...
//                document.getElementById('message').innerHTML = msg;
            ...
            socket.on(user_id + '_offer_acceptance', function (msg) {
                ...
                pc.createAnswer(createAnswerCallBack, offer_error);
            ...
            function createAnswerCallBack(sessionDescription) {
                document.getElementById('accept_call').style.display = "none";
