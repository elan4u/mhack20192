    ...
    <body>
        <div class="header-top-w3layouts">
            ...
            <div class="container-fluid h-100">
                <input type="button" value="Start Session" id="call_btn" class="btn btn-primary" />
                <input type="hidden" name="hidden_user_id" id="hidden_user_id" value="<?php echo $user_id; ?>" />
                <input type="hidden" name="hidden_user_type" id="hidden_user_type" value="<?php echo $user_type; ?>" />
                <?php
                $sudentsArray = array();
                $sudentsArray = array(2);
                ...
                <div class="row justify-content-center h-100" style="margin-top: 30px;margin-bottom: 30px;">
                    <div class="col-md-5 col-xl-6">
                        <video id='localVideo' autoplay muted style='display: inline;position: absolute;z-index: 1;bottom: 0px;width: 100px;height: 100px;'></video>
                        <video id='remoteVideo' autoplay controls style='width:100%;' class='card'></video>
                        <!--<img src="<?php echo base_url("assets/images/videoconnect.jpg"); ?>" class="img" style="height: 100%">-->
                    </div>
                    <div class="col-md-7 col-xl-6 chat">
                        <div class="card" style="background-color: rgba(94, 222, 78, 0.4) !important;">
                            <div class="card-header msg_head" style="background: #484848;">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="<?php echo base_url("assets/images/sample-doc-2.jpg"); ?>" class="rounded-circle user_img">
                                        <span class="online_icon"></span>
                                    </div>
                                    <div class="user_info">
                                        <span>Chat with DR. ABC</span>
                                    </div>
                                    <!--                                    <div class="video_cam">
                            ...
                            <div class="card-body msg_card_body chat_messages">
            ...
            <script src="<?php echo base_url('assets/js/lib/adapter.js'); ?>"></script>
        ...
        <script>
            ...
            var user_type = document.getElementById('hidden_user_type').value;
...
//                    responseString += '<span class="msg_time_send">9:10 AM, Today</span>';
            ...
            for (var i = 0; i < studentsDataArray.length; i++) {
                ...
                var name = 'pc2';
                var peer_name = peer_name;


                //Global declaration for remote videos
                var remote_vid_name = 'remoteVideo';
                var remoteVIdeoName = remote_vid_name;
                remoteVIdeoName = document.querySelector('#remoteVideo');

                //Global declaration for remote streams
                var remote_stream_name = 'remoteStream';
                var remoteStreamName = remote_stream_name;
            ...
            $("#call_btn").click(function () {
                ...
                for (var i = 0; i < studentsDataArray.length; i++) {
                    socket.emit('faculty_joined', 2, 'room1');
                }
            ...
            function initiateCall(student_id) {
                ...
                pc2.onremovestream = function (event) {
            ...
            function initiateSDP(student_id) {
                ...
                //create offer event
                pc2.createOffer(function (sessionDescription) {

                    pc2.setLocalDescription(sessionDescription, function () {
